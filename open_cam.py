...
cam = cv.VideoCapture(0) #Iniciando a WebCam, caso queira analizar um video basta passar o caminho no lugar do da camera
file_name = "haarcascade_frontalface_alt2.xml"
classifier = cv.CascadeClassifier(f"C:\\Users\\Guilherme L Freitas\\OneDrive\\Desktop\\projetos\\detector-de-mascaras\\haarcascades\\{file_name}") #Modelo para reconhecer faces
